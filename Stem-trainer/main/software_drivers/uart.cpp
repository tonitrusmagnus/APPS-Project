...
//     ESP_ERROR_CHECK(uart_set_pin(UART, MP3_TXD_PIN, MP3_RXD_PIN, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE));
// }
// void datatransfer::transferdata(int value, string valuetype) {
// 	char* Txdata = (char*) malloc(100);
//     sprintf(Txdata,"%d %s\r\n", value, valuetype.c_str());
//     ESP_ERROR_CHECK(uart_write_bytes(UART, Txdata, strlen(Txdata)));
//     // while (1) {
