...
#define SERVO_MIN_COUNT        SERVO_COUNT_PER_MS*SERVO_MIN_PULSEWIDTH+1 // SERVO_MIN_PULSEWIDTH*SERVO_COUNT_PER_MS
...
private:
    ...
    int prevAngle = -1; // Set previous angle to -1 to ensure it cant be the same as first angle to be written
